...
async function runRaceSim() {
  ...
  try {
    ...
    const systemPrompt =
      ...
      'Narration: Be witty, sarcastic, chaotic. Can be short or long. Use paddock gossip, jokes, drama, exaggeration, emojis. No code fences.\n' +
    ...
    if (check.ops) {
      ...
      outText = outText || "🤔 Clarify? (no ops this time)";
    }
